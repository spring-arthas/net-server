...
public class BasicConstant {
    ...
    public static final String
        ...
        NIO_MEDIA_STREAM_BIND_IP = "NIO.MEDIA.STREAM.BIND.IP",
        MEDIA_STREAM_PUBLIC_HOST = "MEDIA.STREAM.PUBLIC.HOST",
        MEDIA_STREAM_PUBLIC_SCHEME = "MEDIA.STREAM.PUBLIC.SCHEME",
        ...
        // [修改] 内置 TLS Gateway 配置，替代独立 HAProxy 进程。
        TLS_GATEWAY_ENABLED = "TLS.GATEWAY.ENABLED",
        TLS_GATEWAY_PUBLIC_IP = "TLS.GATEWAY.PUBLIC.IP",
        TLS_GATEWAY_KEYSTORE_PATH = "TLS.GATEWAY.KEYSTORE.PATH",
        TLS_GATEWAY_KEYSTORE_PATH_WINDOWS = "TLS.GATEWAY.KEYSTORE.PATH.WINDOWS",
        TLS_GATEWAY_KEYSTORE_PATH_MACOS = "TLS.GATEWAY.KEYSTORE.PATH.MACOS",
        TLS_GATEWAY_KEYSTORE_PATH_LINUX = "TLS.GATEWAY.KEYSTORE.PATH.LINUX",
        TLS_GATEWAY_KEYSTORE_AUTO_CREATE = "TLS.GATEWAY.KEYSTORE.AUTO.CREATE",
        ...
        USER_SESSION_TOKEN_SECRET = "USER.SESSION.TOKEN.SECRET",
        USER_SESSION_TOKEN_EXPIRE_SECONDS = "USER.SESSION.TOKEN.EXPIRE.SECONDS",
