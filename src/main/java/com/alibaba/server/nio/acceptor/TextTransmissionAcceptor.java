...
public class TextTransmissionAcceptor extends AbstractAcceptor implements Runnable {
    private String acceptor = "";
    private Selector selector = null;

    public TextTransmissionAcceptor(String acceptor) {
        this.acceptor = acceptor;
        this.selector = NioServerContext.getSelector(BasicConstant.NIO_SERVER_MAIN_CORE_TEXT_SELECTOR);
    }
    ...
    public void run() {
        try {
            ...
            log.error(
                    "TextTransmissionAcceptor：文本传输服务端监听处理异常, error = {}",
     ...
     * @param socketChannel
     */
    private void registerTextSocketChannel(SocketChannel socketChannel) throws IOException {
