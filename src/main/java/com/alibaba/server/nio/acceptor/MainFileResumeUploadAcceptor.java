...
public class MainFileResumeUploadAcceptor extends AbstractAcceptor implements Runnable {
    private String ACCEPTOR = "";
    private Selector selector = null;

    public MainFileResumeUploadAcceptor(String acceptor) {
    ...
    private void registerFileSocketChannel(SocketChannel socketChannel) throws IOException {
        ...
        socketChannelContext.setHandlerType("RESUME_UPLOAD");
        ...
        log.info("文件断点续传上传客户端通道成功接入，并完成该 [{}] 连接地址的socketChannel注册selector成功, 远程客户端地址 = {}",
