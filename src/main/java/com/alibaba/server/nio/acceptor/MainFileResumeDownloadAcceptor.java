...
public class MainFileResumeDownloadAcceptor extends AbstractAcceptor implements Runnable {
    private String acceptor = "";
    private Selector selector = null;

    public MainFileResumeDownloadAcceptor(String acceptor) {
        this.acceptor = acceptor;
        this.selector = NioServerContext.getSelector(BasicConstant.NIO_SERVER_MAIN_CORE_FILE_RESUME_SELECTOR);
    }
    ...
    private void registerFileSocketChannel(SocketChannel socketChannel) throws IOException {
        ...
        socketChannelContext.setHandlerType("RESUME_DOWNLOAD");
        ...
        log.info("文件断点续传下载客户端通道成功接入，并完成该 [{}] 连接地址的socketChannel注册selector成功, 远程客户端地址 = {}",
